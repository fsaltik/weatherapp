...
def home(request):
    ...
    if request.method == "POST":
        ...
        api_request = requests.get(
            ...
            "&distance=5&API_KEY=EF4AC231-32FD-47CE-A346-CCA0F4C18AFB")
        ...
        if api[0]['Category']['Name'] == "Good":
            ...
            category_description = "Unhealthy for Sensitive Groups (101 - 150) Although general public is not likely to " \
                                   "be affected at this AQI range, people with lung disease, older adults and children are " \
                                   "at a greater risk from exposure to ozone, whereas persons with heart and lung disease, " \
